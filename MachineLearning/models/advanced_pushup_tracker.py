...
class AdvancedPushupTracker:
    ...
    def analyze_pushup_form(self, keypoints):
        ...
        try:
            ...
            # Average the angles
            avg_elbow_angle = (left_angle + right_angle) / 2 if left_angle > 0 and right_angle > 0 else 0
            ...
            # Rep counting logic
            current_down = avg_elbow_angle < self.min_angle_threshold
            ...
            return {'elbow_angle': 0, 'body_alignment': 0, 'rep_completed': False, 'in_down_position': False}
